...
def start(mesh):
    ...
    md.draw_slice_and_contour(mesh, root)
...
def create_optimal_tree(contour_node):
    ...
    tree_node = TreeNode(contour_node.contour)
    for division in lowest_cost_divisions:
        ...
        tree_node.add_child(child_1, child_2, division.path)
    return tree_node
...
class TreeNode:
    ...
    def add_child(self, child1, child2, path):
        self.children.append(TreeNodeChild(child1, child2, path))

class TreeNodeChild:
    def __init__(self, child1, child2, path):
        self.child1 = child1
        self.child2 = child2
        self.path = path
